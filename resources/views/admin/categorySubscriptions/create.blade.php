...
<div class="card">
    <div class="card-header">
        <h3 class="card-title card_title_center"> {{ __('messages.Add_New') }} {{ __('messages.categorySubscriptions') }} </h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">


        <form action="{{ route('categorySubscriptions.store') }}" method="post" enctype='multipart/form-data'>
            <div class="row">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="form-group text-center">
                        ...
                        <a href="{{ route('categorySubscriptions.index') }}"
