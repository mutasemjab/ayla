...
<div class="card">
    <div class="card-header">
        <h3 class="card-title card_title_center"> {{ __('messages.Add_New') }} {{ __('messages.dealers') }} </h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="activate" id="activate" class="form-control">
                            ...
                            <option @if (old('activate')==1 || old('activate')=='' ) selected="selected" @endif
                                value="1"> activate
                            </option>
                            <option @if (old('activate')==2 and old('activate') !='' ) selected="selected" @endif
                                value="2">
                                disactivate</option>
                        </select>
                        @error('activate')
...
@section('script')
<script src="{{ asset('assets/admin/js/dealers.js') }}">
