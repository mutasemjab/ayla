                ...
                <div class="row my-3">
                    ...
                    <div class="col-md-3">
                        <select name="dealer" class="form-control">
                            <option value=""><?php echo e(__('messages.AllDealers')); ?></option>
                            <?php $__currentLoopData = $dealers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dealer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dealer->id); ?>" <?php echo e(request('dealer') == $dealer->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-3">
                        <select name="sectionUser" class="form-control">
                            <option value=""><?php echo e(__('messages.AllSectionUsers')); ?></option>
                            <?php $__currentLoopData = $sectionUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sectionUser->id); ?>" <?php echo e(request('sectionUser') == $sectionUser->id ? 'selected' : ''); ?>>
                                    <?php echo e($sectionUser->name_ar); ?>
                    ...
                    <?php if(@isset($data) && !@empty($data) && count($data) > 0): ?>
                        <table id="example2" class="table table-bordered table-hover">
                            <thead class="custom_thead">
                                ...
                                <th><?php echo e(__('messages.sectionUsers')); ?></th>
                                <th><?php echo e(__('messages.dealers')); ?></th>
                                <th></th>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($info->sectionUser->name_ar ?? null); ?></td>
                                        <td><?php echo e($info->user->name ?? null); ?></td>
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer-edit')): ?>
                                                <a href="<?php echo e(route('admin.customer.edit', $info->id)); ?>" class="btn btn-sm btn-primary">
                                                    <?php echo e(__('messages.Edit')); ?>

                                                </a>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('admin.customer.export', ['search' => $searchQuery])); ?>" class="btn btn-sm btn-success">Export to Excel</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        ...
                        <br>
                        <?php echo e($data->appends(['search' => $searchQuery, 'dealer' => request('dealer'), 'sectionUser' => request('sectionUser')])->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/ayla/resources/views/admin/customers/index.blade.php ENDPATH**/ ?>