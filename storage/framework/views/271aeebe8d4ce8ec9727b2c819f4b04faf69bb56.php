        ...
        <?php echo csrf_field(); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="commission_under_ten_for_wallet" id="name" class="form-control" value="<?php echo e(old('commission_under_ten_for_wallet')); ?>"    >
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="commission_up_ten_for_wallet" id="name" class="form-control" value="<?php echo e(old('commission_up_ten_for_wallet')); ?>"    >
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input name="commission_for_pay_invoice" id="name" class="form-control" value="<?php echo e(old('commission_for_pay_invoice')); ?>"    >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/ayla/resources/views/admin/settings/create.blade.php ENDPATH**/ ?>